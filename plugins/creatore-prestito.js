...
let texto = `*_🌠 L'Owner @${m.sender.split`@`[0]} ha bisogno di denaro e ha richiesto un prestito al suo staff tramite sborra bot._*\n*➪ Motivo*: ${text}*`;
m.reply('*_🚀 Inviando messaggio di prestito a tutti gli owner di sborra bot._*');
